...
\translate{ Toda la información de la plataforma está en blockchain, la cual es
  accesible por todo el mundo. Esto supone un problema para la privacidad de los
  revisores ya que no todos ellos quieren revelar su identidad. Esto supone que
  hay que explorar diferentes configuraciones para cada uno de los modelos de
  peer review. }
