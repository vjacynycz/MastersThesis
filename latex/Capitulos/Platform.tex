...
this interactions and their implementation are described.
  ...
  \figura{Uml.png}{width=0.9\linewidth}{umlseq}{Sequence
  ...
  \figura{privacyReviewRating.jpg}{width=0.9\linewidth}{PrivacyReviewRating}{Review and Rating privacy models}
