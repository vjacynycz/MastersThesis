...
% If a user wanted to transfer money to it's account to another account, the
% system will add the transaction to a block of data. Then it will try to add a
% random string and apply a hash function. If the result have a with a number of
% leading zeros the transaction will be encrypted and it will be easily
% verificable. Otherwise the system will try to find another random stirng an
