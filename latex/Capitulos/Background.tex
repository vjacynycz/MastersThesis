...
interlinked data called \ii{blockchain}. To sum up, Bitcoin's blockchain is a
...
desired function. This execution has a fee called \bb{gas} that users have to
pay to the network based on how complex is the code they want to run. The
\bb{gas} amount required to execute a function inside a smart contract directly
determines the code quality, as expensive transactions to smart contracts with
high \bb{gas} costs are undesirable.
