...
1620~\cite{bacon1878novum} y fue en 1665 cuando comenzaron a aparecer lo que hoy
consideramos como los primeros journals científicos~\cite{kronick1976history}.
En esa época los editores eran los que tenían que llevar a cabo la revisión de
los artículos que serían publicados en dichos journals.
...
despues de ser publicado.

El proceso de peer review es el que determina la calidad de un paper antes de
ser publicado, ya que un grupo de expertos en la materia juzgaran si el paper es
de calidad o no~\cite{szklo2006quality}. Este proceso puede suponer un indicador
de la calidad de un paper si los revisores son buenos, pero como se mencionó en
la sección \ref{intro}, es dificil determinar si un investigador académico es
buen revisor o no~\cite{callaham_relationship_2007}.
